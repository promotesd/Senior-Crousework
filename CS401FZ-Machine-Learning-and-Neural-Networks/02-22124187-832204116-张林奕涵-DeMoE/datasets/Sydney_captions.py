...
class Sydney_captions(BaseDataset):
    """
    Sydney_captions
    ...
    URL: https://ieeexplore.ieee.org/document/7546397

    Dataset statistics:
    # identities: 613 images,5 sentences/image, 500*500
    """
    dataset_dir = 'Sydney_captions'

    def __init__(self, root='', verbose=True):
        super(Sydney_captions, self).__init__()
        self.dataset_dir = op.join(root, self.dataset_dir)
        self.img_dir = op.join(self.dataset_dir, 'imgs/')

        self.anno_path = op.join(self.dataset_dir, 'dataset.json')
        ...
        if verbose:
            self.logger.info("=> Sydney_captions Images and Captions are loaded")
    ...
    def _process_anno(self, annos: List[dict], training=False):
        ...
        if training:
            ...
            for anno in annos:
                ...
                captions = anno['sentences'] # caption list
            ...
            for anno in annos:
                ...
                caption_list = anno['sentences'] # caption list
